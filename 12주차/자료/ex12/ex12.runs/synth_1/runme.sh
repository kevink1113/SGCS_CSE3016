...
HD_PWD='C:/Users/D-105/ex12/ex12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tfto_decade_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tfto_decade_counter.tcl
