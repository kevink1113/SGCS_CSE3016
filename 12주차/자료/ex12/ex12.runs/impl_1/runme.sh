...
HD_PWD='C:/Users/D-105/ex12/ex12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tfto_decade_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tfto_decade_counter.tcl -notrace
